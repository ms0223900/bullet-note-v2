...
describe('LocalStorageAdapter', () => {
    ...
    describe('Error Handling', () => {
        it('should handle localStorage errors gracefully', async () => {
            ...
            jest.spyOn(LocalStorageAdapter.prototype, 'saveNotes').mockRejectedValueOnce(new Error('Storage quota exceeded'));
            ...
            await expect(testAdapter.saveNotes(testNotes)).rejects.toThrow('Storage quota exceeded');
